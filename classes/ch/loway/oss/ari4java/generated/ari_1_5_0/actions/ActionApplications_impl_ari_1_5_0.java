...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Application_impl_ari_1_5_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Application_impl_ari_1_5_0.class);
return future;
}
