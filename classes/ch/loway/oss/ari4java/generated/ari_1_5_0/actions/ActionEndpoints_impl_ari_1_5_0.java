...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Endpoint_impl_ari_1_5_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Endpoint_impl_ari_1_5_0.class);
return future;
}
