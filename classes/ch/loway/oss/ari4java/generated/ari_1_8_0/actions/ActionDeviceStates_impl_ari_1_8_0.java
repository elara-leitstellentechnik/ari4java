...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<DeviceState_impl_ari_1_8_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), DeviceState_impl_ari_1_8_0.class);
return future;
}
