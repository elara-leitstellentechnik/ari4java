...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Sound_impl_ari_1_6_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Sound_impl_ari_1_6_0.class);
return future;
}
