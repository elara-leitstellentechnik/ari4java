...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Bridge_impl_ari_2_0_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Bridge_impl_ari_2_0_0.class);
return future;
}
 ...
 *********************************************************/
private void buildClearVideoSource(@NotNull String bridgeId) {
reset();
 ...
 *********************************************************/
private void buildSetVideoSource(@NotNull String bridgeId, @NotNull String channelId) {
reset();
