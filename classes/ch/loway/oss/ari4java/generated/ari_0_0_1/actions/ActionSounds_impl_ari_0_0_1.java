...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Sound_impl_ari_0_0_1>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Sound_impl_ari_0_0_1.class);
return future;
}
