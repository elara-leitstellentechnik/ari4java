...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Channel_impl_ari_0_0_1>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Channel_impl_ari_0_0_1.class);
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Variable_impl_ari_0_0_1.class);
return future;
}
