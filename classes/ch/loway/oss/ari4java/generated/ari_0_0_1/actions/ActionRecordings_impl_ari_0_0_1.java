...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<StoredRecording_impl_ari_0_0_1>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), StoredRecording_impl_ari_0_0_1.class);
return future;
}
