...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Endpoint_impl_ari_0_0_1>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Endpoint_impl_ari_0_0_1.class);
return future;
}
