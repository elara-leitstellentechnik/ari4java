...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Bridge_impl_ari_0_0_1>>() {});
return future;
}
 ...
 *********************************************************/
private void buildCreate(@Nullable String type) {
reset();
url = "/bridges";
method = "POST";
...
httpActionAsync(callbackOnceFuture(future), Bridge_impl_ari_0_0_1.class);
return future;
}
 ...
 *********************************************************/
private void buildPlay(@NotNull String bridgeId, @NotNull String media, @Nullable String lang, @Nullable int offsetms, @Nullable int skipms) {
reset();
...
httpActionAsync(callbackOnceFuture(future), LiveRecording_impl_ari_0_0_1.class);
return future;
}
