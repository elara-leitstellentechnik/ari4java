...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<StoredRecording_impl_ari_1_10_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), StoredRecording_impl_ari_1_10_0.class);
return future;
}
 ...
 *********************************************************/
private void buildGetStoredFile(@NotNull String recordingName) {
reset();
...
de.elara.common.utils.concurrent.SafeCompletableFuture<byte[]> future = new de.elara.common.utils.concurrent.SafeCompletableFuture<>();
httpActionAsync(callbackOnceFuture(future), byte[].class);
return future;
}
