...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Channel_impl_ari_1_9_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Channel_impl_ari_1_9_0.class);
return future;
}
