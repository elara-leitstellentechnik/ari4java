...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Bridge_impl_ari_1_7_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Bridge_impl_ari_1_7_0.class);
return future;
}
