...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<StoredRecording_impl_ari_1_7_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), StoredRecording_impl_ari_1_7_0.class);
return future;
}
