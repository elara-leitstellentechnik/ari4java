...
httpActionAsync(callbackOnceFuture(future), new TypeReference<List<Channel_impl_ari_1_7_0>>() {});
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Channel_impl_ari_1_7_0.class);
return future;
}
...
httpActionAsync(callbackOnceFuture(future), Playback_impl_ari_1_7_0.class);
return future;
}
...
httpActionAsync(callbackOnceFuture(future), LiveRecording_impl_ari_1_7_0.class);
return future;
}
